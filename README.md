...
인기프로그램 섹션
- 기존 슬라이드가 넘어갈 때 짤림 현상 복구 
- 이미지 위치 조정

---

세종시즌 섹션 
- 컨텐츠 사이즈를 줄였을때 양옆 마진 사이즈를 메인 컨텐츠에 동일 하게 변경하여 통일감을 줌 
- 아래 텍스트 컨텐츠 내부에 균일하지 못한 css 부분 균일하게 수정 및 ui/ux 깔끔하게 변경

---

이벤트 섹션
- 전체적으로 균등한 구역을 재구축하고 컨텐츠를 가운데 정렬 하여 위화감을 없애줌

---

대관안내 섹션
- 기존에는 세로 정렬로 되어 있어서 컨텐츠의 내용을 한눈에 알아보기 힘들었음 => 가로 정렬 후 구분선을 주어서 한눈에 알아볼 수 있도록 변경 

# media max width 640px css update

메인 배너 섹션
- 처음 들어 갔을 때 전체적으로 가득 차는 이미지 때문에 답답한 기분을 받아서 오른쪽과 같이 이미지 크기를 수정
- 예매하기와 상세보기 버튼이 가운데 정렬이 되어있지 않아서 가운데 정렬로 맞추어 줌

---

인기프로그램 섹션

- 뒤에 보이는 애니메이션 효과를 모바일 기준에선 제거하여 깔끔한 ui로 변경 또한 11개 까지 포스터 양을 늘려서 고객들이 1개씩 볼 수 있도록 조정 

---

세종시즌 섹션

- 위 텍스트 타이틀을 통일감 있게 조정하고 바로가기 위치 재수정

- 아래 이미지의 크기 조절 및 마진 설정 이미지 내부 컨텐츠 재수정 및 반응형 폰트 사용하여 크기 조절이 가능하게 만듬

---

이벤트 섹션
- 뒤에 불필요한 이미지 제거 후 ui 를 깔끔하게 만듦
- 폰트 크기 반응형으로 조절 하여 컨텐츠 알아보기 쉽게 변경
